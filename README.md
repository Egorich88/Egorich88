...
**Technical Leader · Product Creator**  
> 14+ лет в enterprise-разработке и сопровождении.  
Сбер, Иннотех (ВТБ).

Проектирую инструменты для повышения эффективности команд, решаю эксплуатационные проблемы крупных систем.
