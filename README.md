...
### Технический лидер | Создатель продуктов
> 14+ лет в IT:Сбер и Иннотех (ВТБ)

Работаю в сопровождении enterprise-систем, 
где выявляю эксплуатационные проблемы и создаю инструменты для повышения эффективности команд.
